var footer_sct = '<div class="foonterContainer">';
    ...
    footer_sct +='<li><a href="https://t.me/xp_network" target="_blank"><i class="fab fa-telegram-plane"></i> 电报</a></li>';
    footer_sct +='<li><a href="https://twitter.com/xpnetwork_" target="_blank"><i class="fab fa-twitter"></i> 推特</a></li>';
    footer_sct +='<li><a target="_blank" href="https://www.reddit.com/user/XP_network/"><i class="fab fa-reddit"></i> 红迪网</a></li>';
    footer_sct +='</ul>';
    footer_sct +='</div>';
    footer_sct +='</div>';
    footer_sct +='</div>';
